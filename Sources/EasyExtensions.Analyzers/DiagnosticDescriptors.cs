...
namespace EasyExtensions.Analyzers
{
	...
	{
		private static readonly string[] EnforcedSeverityTags =
			[WellKnownDiagnosticTags.CustomSeverityConfigurable];
		private static readonly string[] CompilationEndEnforcedSeverityTags =
			[WellKnownDiagnosticTags.CompilationEnd, WellKnownDiagnosticTags.CustomSeverityConfigurable];

		public static readonly DiagnosticDescriptor FileTooLong = new(
			DiagnosticIds.FileTooLong,
			"Source file is too long",
			"Source file contains {0} code lines, exceeding the maximum of {1}",
			"Maintainability",
